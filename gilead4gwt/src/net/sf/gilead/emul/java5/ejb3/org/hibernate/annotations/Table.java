...
public @interface Table {
	 ...
	 * a secondary table defined by a class or its superclasses and an outer
	 * join for a secondary table defined by a subclass. If set to select then
	 * Hibernate will use a sequential select for a secondary table defined on a
	...
	/**
	 * If true, Hibernate will not try to insert or update the properties
	...
	/**
	 * If enabled, Hibernate will insert a row only if the properties defined by
	 * this join are non-null and will always use an outer join to retrieve the
	 * properties.
	 * 
	 * <b>Only applies to secondary tables</b>
	 */
