 ...
 * given type. The <code>DiscriminatorValue</code> annotation can only be
 * specified on a concrete entity class. If the <code>DiscriminatorValue</code>
 ...
 * {@link DiscriminatorType#STRING STRING}, the discriminator value default is
 * the entity name.
 * 
 * <p>
...
public @interface DiscriminatorValue {
	 ...
	 * 
	 * <p>
	 * If the <code>DiscriminatorValue</code> annotation is not specified and a
	 * discriminator column is used, a provider-specific function will be used
	 * to generate a value representing the entity type. If the
	 * DiscriminatorType is {@link DiscriminatorType#STRING STRING}, the
