...
/**
 * Used as the value of the <code>javax.persistence.cache.storeMode</code>
 * property to specify the behavior when data is read from the database and when
...
public enum CacheStoreMode {
	...
	/**
	 * Insert/update entity data into cache when read from database and when
	 * committed into database. Forces refresh of cache for items read from
	 * database.
	 */
	REFRESH
}
