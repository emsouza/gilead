...
public @interface MapKey {
	 ...
	 * that is used as the map key. If the name element is not specified, the
	 * primary key of the associated entity is used as the map key. If the
	 * primary key is a composite primary key and is mapped as {@link IdClass},
