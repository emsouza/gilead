 ...
 * 
 * <p>
 * A class designated with the <code>MappedSuperclass</code> annotation can be
 * mapped in the same way as an entity except that the mappings will apply only
 ...
 * context of the subclass tables. Mapping information may be overridden in such
 * subclasses by using the {@link AttributeOverride} and
