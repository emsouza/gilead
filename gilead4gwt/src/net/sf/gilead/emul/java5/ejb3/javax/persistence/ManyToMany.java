 ...
 * associated target entity class does not need to be specified; otherwise it
 * must be specified.
 * 
 * <p>
 ...
 * 
 * <p>
 * The same annotation elements for the {@link OneToMany} annotation apply to
 * the <code>ManyToMany</code> annotation.
 * 
 * <pre>
 * 
 *    Example 1:
...
public @interface ManyToMany {
	 ...
	 * associatedentities must be eagerly fetched. The {@link FetchType#LAZY
