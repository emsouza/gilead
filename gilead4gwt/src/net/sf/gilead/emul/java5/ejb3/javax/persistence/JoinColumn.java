...
public @interface JoinColumn {
	 ...
	 * field of the referencing entity; "_"; the name of the referenced primary
	 * key column. If there is no such referencing relationship property or
	 * field in the entity, the join column name is formed as the concatenation
	 * of the following: the name of the entity; "_"; the name of the referenced
	 * primary key column.
	 */
	String name() default "";
