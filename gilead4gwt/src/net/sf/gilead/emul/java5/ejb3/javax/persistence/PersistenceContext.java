...
public @interface PersistenceContext {
	...
	/**
	 * The name by which the entity manager is to be accessed in the environment referencing context, and is not needed
	 * when dependency injection is used.
	 */
	String name() default "";

	/**
	 * The name of the persistence unit. If the unitName element is specified, the persistence unit for the entity
