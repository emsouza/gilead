...
public enum LazyToOneOption {
	 ...
	 * (Bytecode enhancement is mandatory for this option, fall back to PROXY if
	 * the class is not enhanced) This option should be avoided unless you can't
	 * afford the use of proxies
	 */
	NO_PROXY
}
