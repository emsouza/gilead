 ...
 * 
 * <p>
 * The strategy and the discriminator column are only specified in the root of
 * an entity class hierarchy or subhierarchy in which a different inheritance
 * strategy is applied
 * 
 * <p>
 * If the <code>DiscriminatorColumn</code> annotation is missing, and a
 * discriminator column is required, the name of the discriminator column
 * defaults to <code>"DTYPE"</code> and the discriminator type to
...
public @interface DiscriminatorColumn {
	 ...
	 * <p>
	 * Defaults to the provider-generated SQL to create a column of the
