...
/**
 * Mark an Entity or a Collection as immutable. No annotation means the element
 * is mutable.
 * <p>
 * An immutable entity may not be updated by the application. Updates to an
 * immutable entity will be ignored, but no exception is thrown. &#064;Immutable
 * must be used on root entities only.
 * </p>
 * <p>
